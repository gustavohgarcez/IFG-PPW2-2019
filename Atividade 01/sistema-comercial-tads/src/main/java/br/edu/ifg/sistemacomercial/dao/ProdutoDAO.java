...
public class ProdutoDAO {
    ...
    public void salvar(Produto entity) throws SQLException{
        //Ordem das colunas: id, nome, marca, codigo de barras, unidade de medida, categoria
        String sqlInsert = "insert into produto (id, nome, marca, codigo_barras, "
                + "unidade_medida, categoria_id) values (default, ?, ?, ?, ?, ?)";
